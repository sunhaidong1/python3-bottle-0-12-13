...
RUN tar -zxvf cmake-3.27.0-rc1-linux-x86_64.tar.gz && ln -s /var/trade-algo-shandong-dayahead-price-forecast/cmake-3.27.0-rc1-Linux-x86_64/bin/cmake /usr/bin/cmake
RUN pipreqs --debug ./
